...
| ---------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- | ---------------------------------------------------- | --- |
| `MEDIATOR_SOURCES`           | **Required**. List of supported sources to pull files from. A double-pipe-separated list of key->value pairs. Example:<br>`mybucket->https://mybucket.s3.amazonaws.com                                                              |                            | mybucket-dev->https://mybucket-dev.s3.amazonaws.com` | —   |
| `MEDIATOR_RENDERERS`         | Optional. List of supported renderers (PDF, screenshot, etc.) to use. A double-pipe-separated list of key->value pairs. Example:<br>`pdf->https://pdf-renderer.example.com                                                          |                            | screenshot->https://screenshot-renderer.example.com` | —   |
